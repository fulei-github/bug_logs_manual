<!--
 * @Description: 全屏滚动个人介绍
 * @Date: 2022-07-10 11:29:32
 * @Version: 0.1
 * @Autor: fulei
 * @LastEditors: fulei
 * @LastEditTime: 2022-07-10 13:20:20
-->
<template>
...
export default {
  ...
  methods: {
    ...
    directToMove(index) {
      ...
      var scrollHeight // 计算滚动的告诉，是往上滚还往下滚
...
.section1 {
  background-color: rgb(189, 211, 186);
  background: url("../../assets/imgs/me1.png") no-repeat top / cover;
}
